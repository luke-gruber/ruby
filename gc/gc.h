...
MODULAR_GC_FN size_t rb_gc_fstrings_swept_count(void);
MODULAR_GC_FN size_t rb_gc_fstrings_created_count(void);
MODULAR_GC_FN size_t rb_gc_fstring_table_rebuild_count(void);
