...
// TODO: mutexes_lock could be per-thread (on rb_thread_struct) if this
// turns out to be a bottleneck (the sweep thread contending with the mutator).
...
#else
static void mutexes_lock_lock() {}
static void mutexes_lock_unlock() {}
